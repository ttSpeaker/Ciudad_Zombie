...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 280, 150, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 280, 450, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 480, 120, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 80, 60, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 320, 80, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 110, 320, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 800, 120, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 840, 420, 30, 30, 2),
    new Obstaculo('imagenes/auto_verde_abajo.png', 780, 280, 15, 30, 3),
    new Obstaculo('imagenes/auto_verde_derecha.png', 400, 400, 30, 15, 3)
...
Juego.capturarMovimiento = function (tecla) {
  ...
  if (tecla == 'izq') {
    movX = -velocidad;
    Jugador.cambiarSprite('izquierda');
  }
  if (tecla == 'arriba') {
    movY = -velocidad;
    Jugador.cambiarSprite('arriba');
  }
  if (tecla == 'der') {
    movX = velocidad;
    Jugador.cambiarSprite('derecha');
  }
  if (tecla == 'abajo') {
    movY = velocidad;
    Jugador.cambiarSprite('abajo');
  }
...
Juego.dibujar = function () {
  ...
  let xLlegada = 760;
  let yLlegada = 530;
  let tamañoCuadrado = 13;
  for (let i = xLlegada; i < 880; i += 20) {
    Dibujante.dibujarRectangulo("white", i, yLlegada, tamañoCuadrado, tamañoCuadrado);
    Dibujante.dibujarRectangulo("black", i + 10, yLlegada, tamañoCuadrado, tamañoCuadrado);
    Dibujante.dibujarRectangulo("black", i, yLlegada + tamañoCuadrado, tamañoCuadrado, tamañoCuadrado);
    Dibujante.dibujarRectangulo("white", i + 10, yLlegada + tamañoCuadrado, tamañoCuadrado, tamañoCuadrado);
    // Dibujante.dibujarRectangulo("white", i, yLlegada + tamañoCuadrado + tamañoCuadrado, tamañoCuadrado, tamañoCuadrado);
    // Dibujante.dibujarRectangulo("black", i + 10, yLlegada + tamañoCuadrado + tamañoCuadrado, tamañoCuadrado, tamañoCuadrado);
